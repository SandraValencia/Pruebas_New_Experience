...
public class CreateTask implements Task{
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(SelectFromOptions.byIndex(1990).from(CreateUI.SELECT_YEAR_BIRTH));
        ...
        actor.attemptsTo(SelectFromOptions.byIndex(21).from(CreateUI.SELECT_COUNTRY));
